...
r2_training_lasso(X_train)

def r2_training_ridge(X_train_selected):
    ridge_pred_train = ridge.predict(X_train_selected)
...
metrics(X_train_selected, X_test_selected, y_train, y_test, ridge_pred)
r2_training_ridge(X_train_selected)